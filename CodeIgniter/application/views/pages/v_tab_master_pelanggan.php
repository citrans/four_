    ...
    if(isset($data_pelanggan)){
        foreach($data_pelanggan as $row){
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-mini" href="#modalEditPelanggan<?php echo $row->id_pelanggan?>" data-toggle="modal"><i class="icon-pencil"></i> Edit</a>
...
if(isset($data_pelanggan)){
    foreach($data_pelanggan as $row){
        ?>
        <div id="modalEditPelanggan<?php echo $row->id_pelanggan?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('master/edit_pelanggan')?>">
                <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label class="control-label">Email</label>
                        <div class="controls">
                            <input name="email" type="email" value="<?php echo $row->no_telp; ?>">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
