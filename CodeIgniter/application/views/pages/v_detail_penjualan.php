...
<form class="form-horizontal" method="post" action="<?php echo site_url('penjualan/update_tr_jual')?>">
    <div class="control-group">
        <label class="control-label">ID transaksi</label>
        <div class="controls">
            <input class="input-block-level" name="id_tr" type="text" value="<?php echo $row->id_tr_beli?>" required maxlength="30" readonly>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="id_beli" type="text" value="<?php echo $row->id_beli?>" required maxlength="100" readonly>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="barang" type="text" value="<?php echo $row->nama_jenis_barang_distro?>" required maxlength="30" readonly>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="jumlah" type="text" value="<?php echo $row->jumlah_beli?>" required maxlength="30" readonly>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="harga" type="text" value="<?php echo $row->harga_barang?>" required maxlength="50" readonly>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="pesan" type="text" value="<?php echo $row->waktu_beli?>" required maxlength="50" readonly>
        </div>
    </div>
