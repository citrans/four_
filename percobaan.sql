...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2018 at 04:38 PM
...
INSERT INTO `admin` (`id_admin`, `username`, `password`, `no_telp`, `level`) VALUES
...
CREATE TABLE `barang_konveksi` (
  ...
  `bordir/sablon` varchar(6) NOT NULL,
...
INSERT INTO `tabel_pelanggan` (`id_pelanggan`, `username`, `password`, `status`, `no_telp`, `alamat`) VALUES
(1, 'fajar', 'fajar', 1, '089765432123', 'Madura'),
(2, 'rijal', 'rijal', 1, '086789654321', 'jember');
...
--
ALTER TABLE `barang_konveksi`
  MODIFY `id_barang_konveksi` int(2) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `beli`
--
ALTER TABLE `beli`
  MODIFY `id_beli` int(2) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `jenis_barang_distro`
  MODIFY `id_jenis_barang_distro` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tabel_pelanggan`
  MODIFY `id_pelanggan` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tr_beli`
  MODIFY `id_tr_beli` int(2) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tr_pesan`
--
ALTER TABLE `tr_pesan`
  MODIFY `id_tr_pesan` int(11) NOT NULL AUTO_INCREMENT;
--
